<x-app-layout>
    ...
    <x-slot name="pageHeader">
        <div class="dph-inner">
            <div>
                <h1 class="dph-title">Remove EventHost branding</h1>
        ...
        <div class="billing-checkout">
            ...
            <div class="billing-summary-card">
                ...
                <div class="billing-summary-plan">
                    <span class="billing-summary-plan-name">{{ $addon['label'] }}</span>
                    <span class="billing-summary-plan-price">{{ $currency === 'ZMW' ? 'K' : $currency }}{{ number_format($addon['amount'], 0) }}</span>
                </div>
                ...
                <p class="billing-summary-note">
                    ...
                    Secured by Lenco. Non-refundable once branding is removed.
                </p>
            </div>
