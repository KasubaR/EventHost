...
/**
 * JSON sibling of App\Http\Controllers\EventInvitationMediaController — verbatim copy,
 * the web controller was already pure JSON and framework-agnostic. Only the namespace
 * moved. The web controller is untouched by this class.
 */
